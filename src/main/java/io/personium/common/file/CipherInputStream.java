...
public class CipherInputStream extends FilterInputStream {
    ...
    private final int I_BUFFER_SIZE = 512;
    ...
    /**
     * Get length of the stream before encryption.
     * @return length of the stream before encryption.
     */
    public long getReadLengthBeforEncryption() {
        return readLength;
    }
}