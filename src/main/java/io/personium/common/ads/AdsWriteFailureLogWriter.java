...
public final class AdsWriteFailureLogWriter extends AbstractAdsWriteFailureLog {
    ...
    public static synchronized AdsWriteFailureLogWriter getInstance(
        ...
        //   ただし本メソッドの引数には、PersoniumCoreConfigから得られる情報を渡すことを想定している。 本クラスが属する commonモジュールからは
        //   PersoniumCoreConfigを参照できないため、本クラス/PersoniumCoreConfigの属するモジュールをリファクタする以外の手段がないため、
        //   今回はこのままにしておく。
